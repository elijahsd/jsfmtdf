...
/* Generated using JavaScripthon: https://github.com/metapensiero/metapensiero.pj */
	...
	_pj.set_properties(Rules, {"brackets": "[]{}()", "comment": [["\#", "\n", ""]], "comment_string": [["\"\"\"", "\"\"\"", ""], ["'''", "'''", ""]], "f": ["def", "class"], "fields": ".,;", "highlight": ["function"], "numbers": "0123456789", "ops": "=+-*@/%&|^<>:!~\\", "reserved": ["pass", "break", "continue", "global", "nonlocal", "assert", "del", "import", "from", "as", "if", "elif", "else", "while", "for", "in", "with", "try", "except", "finally", "return", "raise", "def", "class", "lambda", "or", "and", "not", "yield"], "spaces": [" ", "\t"], "string": [["\"", "\"", "\\"], ["'", "'", "\\"]], "text": "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890_", "values": ["True", "False", "None"]});
