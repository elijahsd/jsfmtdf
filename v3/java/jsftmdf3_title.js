...
/* Generated using JavaScripthon: https://github.com/metapensiero/metapensiero.pj */
	...
	if (t.rangeCount) {
		...
		n.style.width = "auto";
		n.style.border = "solid #808080";
		n.style.borderWidth = "0.1em .1em .1em .5em";
		n.style.padding = ".2em .6em";
		n.style.borderRadius = "0em .5em .5em .5em";
		n.style.color = "rgb(130,130,130)";
		r.insertNode(n);
		var p = document.createElement('pre');
		n.appendChild(p);
		p.insertAdjacentHTML('afterbegin', o);
		var title = prompt('Title:');
		if (title != null && title.length > 0) {
			var ti = document.createElement('div');
			ti.style.width = "25%";
			ti.style.border = "solid #808080";
			ti.style.borderWidth = "0.1em .1em .0em .5em";
			ti.style.padding = ".2em .6em";
			ti.style.borderRadius = "2em .5em .0em .0em";
			ti.style.paddingLeft = "2em";
			ti.style.color = "rgb(130,130,130)";
			ti.style.overflow = "hidden";
			ti.style.textOverflow = "ellipsis";
			ti.style.whiteSpace = "nowrap";
			n.parentNode.insertBefore(ti, n);
			ti.insertAdjacentHTML('afterbegin', title);
		}
	}
})();
